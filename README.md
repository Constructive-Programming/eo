...
```scala
libraryDependencies += "dev.constructive" %% "cats-eo" % "0.17.0"
// Optional submodules:
libraryDependencies += "dev.constructive" %% "cats-eo-laws"         % "0.17.0" % Test
libraryDependencies += "dev.constructive" %% "cats-eo-generics"     % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-schemes"      % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-schemes-laws" % "0.17.0" % Test
libraryDependencies += "dev.constructive" %% "cats-eo-circe"        % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-avro"         % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-jsoniter"     % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-zio"          % "0.17.0"
libraryDependencies += "dev.constructive" %% "cats-eo-kyo"          % "0.17.0" // JDK 25
```
