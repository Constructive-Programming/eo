...
```scala
libraryDependencies += "dev.constructive" %% "cats-eo" % "0.9.0"
// Optional submodules:
libraryDependencies += "dev.constructive" %% "cats-eo-laws"     % "0.9.0" % Test
libraryDependencies += "dev.constructive" %% "cats-eo-generics" % "0.9.0"
libraryDependencies += "dev.constructive" %% "cats-eo-circe"    % "0.9.0"
libraryDependencies += "dev.constructive" %% "cats-eo-avro"     % "0.9.0"
```
