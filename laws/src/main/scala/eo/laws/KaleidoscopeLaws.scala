...
import optics.Optic
import optics.Optic.*
import _root_.eo.Reflector
import _root_.eo.data.Kaleidoscope
import _root_.eo.data.Kaleidoscope.given
...
/** Law equations for a `Kaleidoscope[S, A]` — `Optic[S, S, A, A, Kaleidoscope]` — parameterised by
  ...
  *
  * @see
  *   `eo.laws.discipline.KaleidoscopeTests` for the discipline RuleSet.
  */
