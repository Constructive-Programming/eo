...
/** Discipline `RuleSet` for [[TraversalLaws]].
  ...
  * `internal.ReplaceLawsTests`, with no Traversal-specific extras at this layer (the fold-side
  * `foldMap` laws live in [[dev.constructive.eo.laws.eo.discipline.FoldMapHomomorphismTests]] and
