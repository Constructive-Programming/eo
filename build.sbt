...
// kindlings module (circe / cats / avro derivation); read by kindlings 0.3.0's `DerivationTimeout`.
...
// kindlings 0.3.0 (all three) ship a configurable macro-expansion timeout
